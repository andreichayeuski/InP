...
public class Sss extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (filename == null) {
            ...
            for (String file : files.list) {
                result.append("<br>").append("<a href='/lab13-1.0-SNAPSHOT/files?file=").append(file).append("' >").append(file).append("</a>");
            }
            result.append("<hr>");
    ...
    public  void  lofFile(String fileName) throws IOException {
        ...
        writer = new BufferedWriter(new FileWriter("D:\\java13\\stdout.txt", true));
